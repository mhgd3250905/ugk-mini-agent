...
export function getStandaloneBaseJs(): string {
	return `
		...
		const THEME_KEY = "ugk-mini-agent:playground-theme";
...
export const STANDALONE_THEME_INLINE_SCRIPT = `<script>(function(){try{var t=localStorage.getItem("ugk-mini-agent:playground-theme");if(t==="light"){document.documentElement.dataset.theme="light";document.documentElement.style.colorScheme="light"}}catch{}})()</script>`;

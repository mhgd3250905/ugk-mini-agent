...
function getPlaygroundScript(): string {
	return `
		...
		const state = {
			...
			connEditorTeamTaskGroups: [],
			connEditorTeamTaskGroupsLoaded: false,
			connEditorTeamTaskGroupsLoading: false,
			connEditorTeamTaskGroupsError: "",
			connEditorTeamTaskGroupsPromise: null,

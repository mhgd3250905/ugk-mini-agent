...
For Team Console UI verification, open `http://127.0.0.1:5174/`, confirm Live API, create through the iframe conversation using `/team-task`, inspect the JSON preview, explicitly confirm, and then verify the new Task appears on the canvas.
